...
| Fase 13 | Geolocalização real e notificações push | 🟡 Em andamento — tarefas 1–4 (backend) concluídas e mergeadas em `dev` via PR #50 (2026-07-28); front concluiu geolocalização (etapas 5–6, sessões 31–32) — falta a etapa 7 (push) do front e a etapa 8 (hardening conjunto — `../squadup-front/.status/roadmap.md` §20) |
