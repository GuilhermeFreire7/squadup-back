...
| Fase 13 | Geolocalização real e notificações push | 🟡 Em andamento — tarefas 1–4 (backend, esta sessão) concluídas em `feature/fase-13-geo-push`; falta só o hardening conjunto (etapa 8, depende do front — `../squadup-app/.status/roadmap.md` §20 — ainda não iniciado) |
...
>
> **Atualização (2026-07-28): tarefas 1–4 concluídas** na branch `feature/fase-13-geo-push`.
