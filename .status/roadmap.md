...
| Fase 13 | Geolocalização real e notificações push | 🟡 Em andamento — tarefas 1–4 (backend) concluídas e mergeadas em `dev` via PR #50 (2026-07-28); falta só o hardening conjunto (etapa 8, depende do front — `../squadup-front/.status/roadmap.md` §20 — ainda não iniciado) |
